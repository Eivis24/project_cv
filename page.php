		...
		<!-- 		<span class="logo_img">
				...
				<div class="helper1">
					<div class="about col-lg-12">
						<img class="profile col-lg-2" src="#" alt="profile foto">
						<span class="about-by-img col-lg-7">
							<section>
								<h1>
									<!-- Eivydas Petryla -->
									Smith Anderson
						...
						<div id="text">
							...
							<div>
								<a id="phone" href="tel:+37065555555">
									<i class="fa fa-phone" aria-hidden="true">+37065555555</i>
								</a>
								<a id="email" href="mailto:epastas@tekejas.lt">
									<i class="fa fa-envelope" aria-hidden="true">epastas@tekejas.lt</i>
								</a>
							</div>
						</div>
						</div>
